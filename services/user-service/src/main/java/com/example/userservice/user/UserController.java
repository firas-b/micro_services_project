...
public class UserController {
    ...
    @GetMapping ("/keyclaok/{id}")
    public ResponseEntity<UserResponse> getKeyClaim(@PathVariable("id") String id){

        return ResponseEntity.ok(userService.getUserbykeyclaokIDd(id));
    }
}
